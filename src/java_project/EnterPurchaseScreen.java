...
public class EnterPurchaseScreen extends javax.swing.JFrame {
    ...
    JPanel contentPane = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            try {
                Image backgroundImage = ImageIO.read(new File("C:\\Users\\Lenovo\\Pictures\\Saved Pictures\\img9.jpg"));
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        ...
        Purchase purchase = Purchase.getInstance(); // Use the singleton instance
        double newBalance;
